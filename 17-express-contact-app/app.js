...
const { loadContacts, findContact, addContact, cekDuplikat, deleteContact, updateContacts } = require("./utilities/contacts");
...
app.get("/contact/delete/:id", (req, res) => {
    ...
    if (!contact) {
        ...
        deleteContact(id);
        req.flash("msg", "Contact was successfully deleted !");
        res.redirect("/contact");
    }
});
...
app.post(
    ...
    (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            // kirimkan flash message
            req.flash("msg", "Contact was successfully updated !");
            res.redirect("/contact");
